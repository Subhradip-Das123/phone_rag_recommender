PHONES = [
    ...
    ("Infinix Hot 50", 7999, "Best entry-level phone, long battery life",
     "https://www.flipkart.com/infinix-hot-50-5g"),

    ("Samsung Galaxy F06", 9999, "Good display, reliable everyday performance",
     "https://www.flipkart.com/samsung-galaxy-f06-5g"),

    ("Samsung Galaxy M06", 9999, "Trusted brand, big battery, 5G",
     "https://www.amazon.in/dp/B0DX6P3RX9"),

    ("Motorola g35 5G", 9999, "Clean UI, long battery life",
     "https://www.flipkart.com/motorola-g35-5g"),
    ...
    ("iQOO Z9s 5G", 18400, "Best performance phone under 20K",
     "https://www.flipkart.com/iqoo-z9s-5g"),

    ("Realme P4 5G", 17999, "Excellent camera with OIS",
     "https://www.flipkart.com/realme-p4-5g"),

    ("Realme P3 5G", 18499, "Snapdragon 6 Gen 4 chipset",
     "https://www.flipkart.com/realme-p3-5g"),
    ...
    ("Realme 15 5G", 27999, "Strong specs, good overall value",
     "https://www.amazon.in/s?k=realme+15+5g"),

    ("Oppo F31 Pro 5G", 26999, "Good battery life and camera balance",
     "https://www.flipkart.com/search?q=oppo+f31+pro+5g"),

    ("Google Pixel 8a", 27999, "Best camera under 30K",
     "https://www.amazon.in/s?k=google+pixel+8a"),

    ("Vivo V60e", 27990, "Good performance and battery life",
     "https://www.flipkart.com/search?q=vivo+v60e"),

    ("Nothing Phone 3a Pro", 27900, "Unique design, clean UI",
     "https://www.flipkart.com/search?q=nothing+phone+3a+pro"),
